...
Audience: Data engineers and functional mapping reviewers. Useful action: Validate the sample mapping and inspect semantic changes and lineage.

## Sources and publication

- Canonical publication: https://dkharlanau.github.io/mapping-as-code/
...
Compare a mapping workbook with a versioned transformation contract using an explicit changed field and failed boundary case.
